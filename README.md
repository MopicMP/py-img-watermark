...
[![PyPI version](https://badge.fury.io/py/py-img-watermark.svg)](https://pypi.org/project/py-img-watermark/)
...
# Basic usage
result = watermark("your input here")
print(result)
```
...
result = watermark("Hello World")

# Example 2: Batch processing
from py_img_watermark import batch
